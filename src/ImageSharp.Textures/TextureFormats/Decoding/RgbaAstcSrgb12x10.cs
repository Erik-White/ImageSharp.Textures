...
/// <summary>
/// Texture compressed with the sRGB variant of ASTC 12x10
/// </summary>
internal readonly struct RgbaAstcSrgb12X10 : IBlock<RgbaAstcSrgb12X10>
{
    ...
    public byte[] Decompress(byte[] blockData, int width, int height) =>
        AstcDecoder.DecompressImage(blockData, width, height, BlockSize.Width, BlockSize.Height, this.CompressedBytesPerBlock, LdrDecodeMode.Srgb);
}
